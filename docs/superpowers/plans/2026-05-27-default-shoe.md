...
Edit `/home/tim/.claude/projects/-home-tim-projects-runscribe/memory/MEMORY.md`. Update the line under "Known Code Patterns":
...
```bash
git add requirements.md /home/tim/.claude/projects/-home-tim-projects-runscribe/memory/MEMORY.md
